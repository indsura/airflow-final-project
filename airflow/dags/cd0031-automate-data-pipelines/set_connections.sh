...
#
airflow connections add aws_credentials --conn-uri 'aws://AKIAT2NWSQ55A7N4TBV4:Xez9I9QI4fcpxfG7NwOJ2Ku2ZBJwmnvy6iowy1Ta@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
# "conn_type": "redshift", 
# "description": "", 
# "host": "default-workgroup.262912771962.us-east-1.redshift-serverless.amazonaws.com", 
# "schema": "dev", 
# "login": "awsuser", 
# "password": "R3dsh1ft", 
# "port": "5439", 
...
# "is_extra_encrypted": "False", 
# "extra_dejson": {}, 
# "get_uri": "redshift://awsuser:R3dsh1ft@default-workgroup.262912771962.us-east-1.redshift-serverless.amazonaws.com:5439/dev"}]
#
# Copy the value after "get_uri":
#
...
# TO-DO: Update the following command with the URI and un-comment it:
#
airflow connections add redshift --conn-uri 'redshift://awsuser:R3dsh1ft@default-workgroup.262912771962.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
# TO-DO: update the following bucket name to match the name of your S3 bucket and un-comment it:
#
airflow variables set s3_bucket indira-srini2
#
